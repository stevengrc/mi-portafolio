    ...
    >
      ...
      <div className="sm:w-1/2 text-center md:text-left">
        ...
        <p className="text-gray-300 leading-relaxed mb-4">
          Soy{" "}
          <span className="text-cyan-400 font-semibold">ingeniero en sistemas</span>{" "}
          graduado de la{" "}
          ...
          , diseño de bases de datos e integración de tecnologías modernas como{" "}
          <span className="text-cyan-400">
            <i>Node.js, React, FastAPI y PostgreSQL</i>
          </span>
          .
        </p>
        <p className="text-gray-400">
          Me apasiona crear soluciones digitales innovadoras, eficientes y centradas en la experiencia del usuario.
        </p>
      </div>
