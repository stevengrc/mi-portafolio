  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(0,255,255,0.15), transparent 10%)",
          mixBlendMode: "screen",
        }}
      />
      ...
      <div className="z-10 px-6">
        <h1 className="text-5xl md:text-6xl font-bold mb-4 text-white drop-shadow-lg">
          <span className="text-cyan-400 font-mono bg-cyan-900/30 px-2 py-1 rounded-lg">
            &lt;&gt;
          </span>{" "}
          {t("hero.greeting")}{" "}
          <span className="text-cyan-400">Steven Garcia</span>
        </h1>
